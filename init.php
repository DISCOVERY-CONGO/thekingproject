...
$repertoire = dir(".");
//$dossier = get_repertoire();
//if(in_array(needle, haystack))
require('models/autoloader.php');
if(isset($controleur)){ spl_autoload_register(array('autoloader' ,'autoload_controleur' )); }else{
spl_autoload_register(array('autoloader' ,'autoload_one'));
spl_autoload_register(array('autoloader' ,'controleur'));

//'autoload_controleurs';
}
