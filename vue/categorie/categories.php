...
<div class="card">
  <div class="card-body">
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">créer une categorie</button>

<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">créér une categorie</h5>
      ...
      <div class="modal-body">
        ...
        <label for="recipient-name" class="col-form-label">nom:</label>
          ...
          <div class="modal-footer">
            <button name="categorie" type="submit" class="btn btn-primary">créer</button>
          </div>
        </form>
      </div>
